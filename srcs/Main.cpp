...
int	main() {
	...
	glBufferData(GL_ARRAY_BUFFER, Map.GiveVertexBufferSize() * sizeof(glm::vec3), &Map.GiveVertexBuffer()[0], GL_DYNAMIC_DRAW);
	// glBufferData(GL_ARRAY_BUFFER, sizeof(g_vertex_buffer_data), g_vertex_buffer_data, GL_DYNAMIC_DRAW);
	std::cout << Map.GiveVertexBufferSize() << std::endl;
